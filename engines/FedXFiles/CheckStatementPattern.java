...
public class CheckStatementPattern implements StatementTupleExpr, BoundJoinTupleExpr {
	...
	public StatementPattern getStatementPattern() {
        ...
        public List<ExclusiveStatement> getStatementPatterns() {
                return ((ExclusiveGroup)stmt).getStatements();
        }

        public boolean isExclusiveGroupStatement() {
                return (stmt instanceof ExclusiveGroup);
        }	
