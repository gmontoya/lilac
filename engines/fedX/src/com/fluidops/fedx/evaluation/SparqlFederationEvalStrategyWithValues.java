		...
		throws QueryEvaluationException {
			...
			String preparedQuery = null;
                if (stmt instanceof StatementPattern) {
                    preparedQuery = QueryStringUtil.selectQueryStringBoundJoinVALUES((StatementPattern)stmt, bindings, filterExpr, isEvaluated);
		} else if (stmt instanceof ExclusiveGroup) {
                    preparedQuery = QueryStringUtil.selectQueryStringBoundJoinVALUES(((ExclusiveGroup)stmt).getStatements(), bindings, filterExpr, isEvaluated);
                }
